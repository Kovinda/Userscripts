...
(function() {
    ...
    GM_addStyle(`
        * {
        ...
        html body .kp-wholepage-osrp [data-attrid="kc:/tv/tv_program:cast"] .c5Iaje.fPCXaf {
            background: var(--tm-glass-strong-bg, rgba(18, 18, 18, 0.6)) !important;
            border: 1px solid var(--tm-glass-border, rgba(255, 255, 255, 0.16)) !important;
        ...
        html body .kp-wholepage-osrp [data-attrid="kc:/tv/tv_program:cast"] .c5Iaje.fPCXaf .llyPJc {
        ...
        #jOAHU > .A6K0A .kp-wholepage-osrp [data-attrid="kc:/tv/tv_program:cast"] .c5Iaje.fPCXaf {
            background: var(--tm-glass-strong-bg, rgba(18, 18, 18, 0.6)) !important;
            border: 1px solid var(--tm-glass-border, rgba(255, 255, 255, 0.16)) !important;
            border-radius: 20px !important;
            padding: 14px 16px !important;
